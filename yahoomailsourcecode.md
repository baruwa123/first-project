...
<!-- static compact footer -->
	...
	<![endif]--><div id="mem_ft">
    <p> Copyright Â© 2012 Yahoo! Inc. All rights reserved.</p>
    <p>
...
<script type="text/javascript" src="https://s.yimg.com/lq/lib/reg/js/yahoo_dom_event_animation_connection_2.8.2_inc_superads_capslock_loginmd5_min_12.js"></script>
	...
	YAHOO.util.Event.addListener("login_form", "submit", sbmCp);
            ...
            if(aea !== undefined) {
                if(aea.length > 0) {
                    ...
                    for(var i=0; i<aea.length; i++) {
                        email = aea[i][i];
                        emailMarkup = '<li><input name="aeaSelect" id="aeaSelectEmail'+i+'" type="radio" style="width:15px;" class="aeaSelect" rel="4|'+i+'|'+email+'|EMAIL">'+email+'</li>';
		...
		function getCv5() {
						...
						YAHOO.util.Connect.asyncRequest('GET', "/captcha/CaptchaWSProxyService.php?action=createlazy&initial_view=&.intl=us&.lang=en", callback1);
					}
...
<!-- spaceid: 150002529 INT.OFFSET: 0 --><!-- SpaceID=150002529 loc=FR05 noad -->
<!--QYZ ,;;;150002529;11;--><!-- login.yahoo.com Sat Jan 21 6:34:15 PST 2012 -->
</body>
</html>
...
if(window.yzq_p)yzq_p('P=b02cjGKL8V6wjaPgTxrM3AE.rmHl_E8azOcAA1Sr&T=18eq3ad27%2fX%3d1327156455%2fE%3d150002529%2fR%3dreglsa%2fK%3d5%2fV%3d1.1%2fW%3dJ%2fY%3dYAHOO%2fF%3d907362767%2fH%3dc2VjdXJlPSJ0cnVlIiBzZXJ2ZUlkPSJiMDJjakdLTDhWNndqYVBnVHhyTTNBRS5ybUhsX0U4YXpPY0FBMVNyIiBzaXRlSWQ9IjQ0NTQ1NTEiIHRTdG1wPSIxMzI3MTU2NDU1MjQxNTE4IiA-%2fS%3d1%2fJ%3d80918B62');
if(window.yzq_s)yzq_s();
</script><noscript><img width=1 height=1 alt="" src="https://us.bc.yahoo.com/b?P=b02cjGKL8V6wjaPgTxrM3AE.rmHl_E8azOcAA1Sr&T=18jrirrco%2fX%3d1327156455%2fE%3d150002529%2fR%3dreglsa%2fK%3d5%2fV%3d3.1%2fW%3dJ%2fY%3dYAHOO%2fF%3d525480363%2fH%3dc2VjdXJlPSJ0cnVlIiBzZXJ2ZUlkPSJiMDJjakdLTDhWNndqYVBnVHhyTTNBRS5ybUhsX0U4YXpPY0FBMVNyIiBzaXRlSWQ9IjQ0NTQ1NTEiIHRTdG1wPSIxMzI3MTU2NDU1MjQxNTE4IiA-%2fQ%3d-1%2fS%3d1%2fJ%3d80918B62"></noscript><script language=javascript>
...
if(window.xzq_svr)xzq_svr('https://csc.beap.ad.yieldmanager.net/');
if(window.xzq_p)xzq_p('i?bv=1.0.0&bs=(12858tkn8(gid$b02cjGKL8V6wjaPgTxrM3AE.rmHl_E8azOcAA1Sr,st$1327156455241518,v$1.0))&t=J_3-D_3');
if(window.xzq_s)xzq_s();
</script><noscript><img width=1 height=1 alt="" src="https://csc.beap.ad.yieldmanager.net/i?bv=1.0.0&bs=(12858tkn8(gid$b02cjGKL8V6wjaPgTxrM3AE.rmHl_E8azOcAA1Sr,st$1327156455241518,v$1.0))&t=J_3-D_3"></noscript>
<!-- l08.member.bf1.yahoo.com uncompressed/chunked Sat Jan 21 06:34:15 PST 2012 -->
